...
export const createUser = async (req, res) => {
    try {
        ...
        export const getUsers = async (req, res) => {
            try {
                const usuarios = await User.findAll({ include: [{ model: Task, as: 'tasks', attributes: ['id', 'title', 'description', 'isComplete'] }] });
        ...
        export const getUserById = async (req, res) => {
            try {
                const usuario = await User.findByPk(req.params.id, { include: [{ model: Task, as: 'tasks', attributes: ['id', 'title', 'description', 'isComplete'] }] });
